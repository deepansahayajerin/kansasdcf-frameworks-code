...
{
    public class Oracle_SQLCA : PredefinedRecordBase
    {
        ...
        {
            internal const string CPY_SQLCA = "Oracle_SQLCA";
        ...
        /// <summary>
        /// Defines the entirety of the CPY_SQLCA IRecord structure as described by the MDSY.Framework.Buffer API.
        /// </summary>
        ...
        public Oracle_SQLCA(IRecord recordBuffer, bool isNewCopy)
            : base()
        {

...
namespace MDSY.Framework.Data.DB2
{
    public class DBConversation
    {
        ...
        public DB2_SQLCA SQLCA { get; set; }
        #endregion
        ...
        public void ExecuteSqlQuery(string sqlString, params Object[] parms)
        {
            ...
            try
            {
                ...
                SimpleLogging.LogMessageToFile(string.Concat("DB2 SQL: ", _command.CommandText, FormatCommandParms(_command)));
            }
            catch (Exception ex)
            {
        ...
        private void CreateReader(ReaderQuery rQuery)
        {
            ...
            try
            {
                ...
                SimpleLogging.LogMessageToFile(string.Concat("DB2 Open Reader: ", rQuery.ReaderName, ": ", _command.CommandText, FormatCommandParms(_command)));
                SetSqlCode(0);
            }
            catch (Exception ex)
            {
        ...
        {
            DbParameter dbParm;
            if (parmField.DBColumnType == DBColumnType.DB2TimeStamp)
            {
                if (nullFlag)
            ...
            else
            {
                if (nullFlag)
                    ...
                    dbParm = CreateParameter(parmName, parmField.AsStringForDB2());
            }
                        ...
                        else
                        {
                            ...
                            else if (field is IField)
                            {
                                ...
                                else if (selectDT.Columns[colCtr].DataType == typeof(System.DateTime))
                                {
                                    ...
                                    if (tempField.DBColumnType == DBColumnType.DB2TimeStamp)
                                    {
